...
var OrbitDB = function () {
  function OrbitDB(ipfs, identity) {
    ...
    this._pubsub = options && options.broker ? new options.broker(this._ipfs) // eslint-disable-line
          ...
          while (1) {
            switch (_context18.prev = _context18.next) {
              ...
              case 10:
                ...
                return _context18.abrupt('return', OrbitDBAddress.parse(path.join('/orbitdb', manifestHash, name)));
